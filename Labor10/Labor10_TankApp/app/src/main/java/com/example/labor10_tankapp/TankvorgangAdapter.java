...
public class TankvorgangAdapter extends RecyclerView.Adapter<TankvorgangAdapter.TankvorgangViewHolder> {
    ...
    public TankvorgangViewHolder onCreateViewHolder (@NonNull ViewGroup parent, int viewType) {
        return new TankvorgangViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item, parent, false), onClickListener);
    }
    ...
    public void onBindViewHolder (@NonNull TankvorgangViewHolder holder, int position) {
        ...
        holder.date.setText(tankvorgang.getDate().toString());
        holder.oldKm.setText(String.format(Locale.ENGLISH, "%.2f", tankvorgang.getOldKm()));
        holder.newKm.setText(String.format(Locale.ENGLISH, "%.2f", tankvorgang.getNewKm()));
        holder.liters.setText(String.format(Locale.ENGLISH, "%.2f", tankvorgang.getLiters()));
        holder.pricePerLiter.setText(String.format(Locale.ENGLISH, "%.2f", tankvorgang.getPricePerLiter()));
    }
